...
module.exports = {
    ...
    usage:'<path1> <path2> <path3>',
      ...
      const helpembed = new Discord.RichEmbed()
		  ...
		  .addField('usage:','q!emoji ``<top text>`` ``<bottom text>``(select **one** bottom text)\n**e.g.q!emoji supermonkey happy**')
