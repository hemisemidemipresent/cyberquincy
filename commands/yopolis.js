...
module.exports ={
    ...
    execute(message,args){
        if(!args.length){
			return message.channel.send('# The usage is:\nq!mp <total farm cost> <total farm amount>',{code:'md'})
		}
		if(isNaN(args[0])==true){
			return message.channel.send('Please Specify a **number** for the cost of the farm')
		}
