    ...
    if (round > 80 && recognisable === 1) {
      ...
      if (args[0] === "moab" || args[0] === "MOAB") {
        ...
        message.channel.send(
          "hmm... something went wrong. perhaps you inputted a wrong statement, or misspelled something. if problem persists, join the bot support server:var recognisable = 1"
        );
      }
    }
    if (args[0] === "test") {
